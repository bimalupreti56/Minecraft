...
public class ModPlacedFeatures {
    public static final RegistryKey<PlacedFeature> BIMAL_ORE_PLACED_KEY = registerKey("bimal_ore_placed");
    ...
    public static void bootstrap(Registerable<PlacedFeature> context) {
        ...
        register(context, BIMAL_ORE_PLACED_KEY, configuredFeatureRegistryEntryLookup.getOrThrow(ModConfiguredFeatures.BIMAL_ORE_KEY),
