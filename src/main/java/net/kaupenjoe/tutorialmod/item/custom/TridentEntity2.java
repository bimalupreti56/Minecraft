...
public class TridentEntity2 extends PersistentProjectileEntity {
    ...
    public TridentEntity2(EntityType<? extends net.minecraft.entity.projectile.TridentEntity> entityType, World world) {
        super(entityType, world);
        this.tridentStack = new ItemStack(Items.TRIDENT);
    }

    public TridentEntity2(World world, LivingEntity owner, ItemStack stack) {
        super(EntityType.TRIDENT, owner, world);
        this.tridentStack = new ItemStack(Items.TRIDENT);
//        this.tridentStack = stack.copy();
//        this.dataTracker.set(LOYALTY, (byte)EnchantmentHelper.get(stack));
